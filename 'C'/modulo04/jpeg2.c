...
{
     // Garanta o uso adequado garantindo que o usuario informe o nome do programa, o arquivo de origem e o arquivo de destino
     if(argc != 3)
     {
     ...
     // abrindo com w porque ele quer colocar o programa nesse destino
